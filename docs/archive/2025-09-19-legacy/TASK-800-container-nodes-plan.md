# TASK‑800: Hierarchical Container Nodes (POP & CORE_SITE) with Snap Logic
...
- User can link CPE → POP → AON_SWITCH ohne hunting pixels; result is a real device‑to‑device link
...
- Merge phases incrementally; keep PRs small (≤3 files where possible)
