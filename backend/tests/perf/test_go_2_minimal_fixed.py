"""
HGO-010 Minimal Test: 2 ONTs
=============================
Purpose: Verify BFS works at all before scaling to 192 ONTs.
...
- 1 ODF
- 2 ONTs
Total: 6 devices, 5 links

Expected: <1s per tick @ 6 devices
"""
...
def topology_2_minimal():
    ...
    with get_session() as s:
        ...
        # 8. Provision devices (correct order: Core → OLT → ONTs strand-by-strand)
